...
load('Case1_Langmuir_GridEDFM5mdft_PROS_EDFM.mat');
load('Case1_Langmuir_5mdft_PROS_EDFM.mat');

Data_Ref1 = csvread('CMG_Desorption5mdft.csv',6,1);

%% Gas flow rate Plot
%MRST-Shale
t0=time_list;
y0=Case1_Fcd5mdft_GasPro;
y1=Case1_Grid_EDFM5mdft_GasProEDFM; 
y2=Case1_Fcd5mdft_GasProEDFM; 
