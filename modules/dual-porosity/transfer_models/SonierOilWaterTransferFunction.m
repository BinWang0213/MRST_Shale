classdef SonierOilWaterTransferFunction < TransferFunction
    % Sonier 1988 2 Phase Transfer Function
    ...
    methods
        ...
        function transferfunction = SonierOilWaterTransferFunction(shape_factor_name,block_dimension)
...
%             krot = krO;
            ...
            to=-(sigma.*bOm.*krot./muom).*(pO-pom+dwo.*(hwf-hwm));
