classdef SequentialPressureTransportDPModel < DualPorosityReservoirModel
    ...
    methods
        function model = SequentialPressureTransportDPModel(pressureModel, transportModel, varargin)
            model = model@DualPorosityReservoirModel([]);
            % Set up defaults
