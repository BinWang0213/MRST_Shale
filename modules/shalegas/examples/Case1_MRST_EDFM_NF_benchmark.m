...
[G,fl] = ExplicitFracGridNF(physdim,...
    ...
    'NY_OutRefine',16,...
    'FracCellSize',0.01*ft,...
    'FracCellSize_Y',20*ft,...
    'NumNFs',3,'NY_Refine',6,'NY_LogRefine',false,...
    'NF_Spacing',2*Frac_halfLength/3,'NF_Length',200*ft,...
    'NF_RepeatPatternSpace',215*ft,...
    'NF_StartXY',[Frac_StartXY(1)-307*ft Frac_StartXY(2)]);
%}
NumHydraulicFracs=1;
...
%Plot Fracture Map
plotFracGeo(physdim,fl,xy_wells,'FigSize',600,'Title','EDFM1 Grid');
%Plot Grid
